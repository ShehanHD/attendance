...
import {fetchAllEntriesForMonth, fetchClosures, fetchEmployees, fetchEntries, saveEntries,} from './mongoApi'
...
const mockEmployee: {
    ...
    isAdmin: boolean;
    isActive: boolean
} = {_id: 'e1', name: 'Alice', standardHours: 8, isAdmin: false, isActive: true}
